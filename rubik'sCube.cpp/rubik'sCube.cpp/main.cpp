...
/* FOR INPUT ARRAYS :
 The matrix represents the face of the cube and the numbers represent the index of the corresponding position in the input array.
 
 | 6 7 0 |
 | 5 8 1 |   -> GREEN, RED, BLUE, ORANGE.
 | 4 3 2 |
